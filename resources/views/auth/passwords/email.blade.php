...
<div class="container" style="margin-top:15%;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Reestablecer Password') }}</div>
                ...
                <div class="card-body">
                  ...
                  <div class="alert alert-success" role="alert">
                    <h4>Listo!! </h4>Hemos enviado el link de cambio de contraseña a tu correo.
                  </div>
                  @endif
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-success">
                                    {{ __('Enviarme el link de recuperación') }}
                                </button>
                            </div>
                        </div>
                    </form>
