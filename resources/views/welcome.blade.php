...
<script src="https://kit.fontawesome.com/e838e8d238.js" crossorigin="anonymous"></script>
    ...
    <body>
        <div class="flex-center position-ref full-height" id="btn_top">
            @if (Route::has('login'))
                <div class="top-right links text-right" id="fix"
                style="position:absolute; z-index:2; min-height:80px; padding:5px;">

                <a href="/bloques" id="bloques"
                class="btn btn-success"
                 style="color:#fff;">Blocks <i class="fas fa-cubes"></i></a>

                 <a href="/nodos" id="nodos"
                 class="btn btn-success"
                  style="color:#fff;">Nodos <i class="fab fa-connectdevelop"></i></a>

                  <a href="/precio"
                  class="btn btn-success"
                   style="color:#fff;">Precio <i class="fas fa-hand-holding-usd"></i></a>


                  <!--<a href="{{ url('/api_reference') }}" style="color:#fff;">API Documentación</a>-->

                    @auth
                        <a href="{{ url('/home') }}" class="btn btn-outline-primary">Home <i class="fas fa-home"></i></a>
                    @else
                        <a href="{{ route('login') }}"

                        class="btn btn-success"
                         style="color:#fff;">Acceder <i class="fas fa-user-shield"></i></a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                            class="btn btn-success"
                            style="color:#fff;" >Registrarme <i class="fas fa-user-plus"></i></a>
                        @endif
                    @endauth



                    <img id="coina" style="width:4%;" src="/coin_green2.png"/>
                </div>
            @endif
...
<div>
              ...
              <div class="row text-center" style="margin-bottom:100px; ba">
                  <div class="col-md-12" style="margin-top:9%;" id="first_title">
                        <h3>Goicoin Criptomoneda, el dinero digital del internet.</h3>
                        <hr>
                  </div>


                  <div class="col-md-4" style="padding:50px; padding-left:100px;">
                    <img id="logo_main" width="100%" src="/logo_green.png"/>
                  ...
                  <div class="col-md-4">
                    <video video width="300" autoplay muted loop id="myVideo">
                      <source src="/green_oceans.mp4" type="video/mp4">
                      Your browser does not support HTML video.
                    </video></div>

                    <div class="col-md-12" style="margin-top:50px; background-color:#000;">
                      <p>Con tu cuenta, compra en linea y envia activos de manera inmediata y segura gracias a nuestra red de bloques (Blockchain)
                        <br>
                      Obten una Billetera Digital y Descargala, Accede a Plataformas
                      Esclusivas y Gana Invirtiendo.
                    <br>
                  <li>Compras</li>
                  <li>Transferencias</li>
                  <li>Envios e Inversiones</li>
                  <li>Cajeros ATM Efectivo</li>
                </p>
                    </div>
...
<script>
      ...
      function detec() {
          ...
          if (navigator.userAgent.match(/Android/i)
              ...
              a = true;
              $("#myVideo").remove();
              $("#logo_main").css("width","80%");
              $("#btn_top").css("margin-top","30px");
              $("#first_title").css("margin-top","100px");
              $("#bloques").remove();
              $("#nodos").remove();
              $("#coina").remove();
  ...
  var myChart = new Chart(ctx, {
      type: 'bar',
      data: {
          labels: ['Litecoin', 'Bitcoin', 'Ethereum', 'Goicoin', 'Bebacoin', 'Dash'],
          datasets: [{
              label: '# Price Rates 24hrs',
              data: [12, 19, 3, 5, 2, 3],
              backgroundColor: [
                  'rgba(255, 99, 132, 0.2)',
                  'rgba(54, 162, 235, 0.2)',
