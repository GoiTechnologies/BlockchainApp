...
<div class="container" style="margin-top:9%;">
	<div class="text-center">
        ...
        <form  action="/cancelar_operacion" method="post">
          @csrf
          <input class="form-control" name="ide" value="1" hidden/>
  ...
  $.ajaxSetup({
      ...
      success: function(respuesta) {
            ...
            if(respuesta.state == '3'){
              ...
              window.location = "https://goicoin.net/success_deposito?cantidad={{$cantidad}}&ide=1&response=goicoin&wallet={{$wallet_to}}";
            }
      }
      });
}
